...
namespace RPGGame
{
    ...
    {
        [SerializeField] private float weaponAttackAmount = 0f;
        [SerializeField] private float ownerAttackAmount = 0f;
        ...
        protected override void Awake()
        {
            ...
            if (weaponItem != null)
            {
                weaponAttackAmount = weaponItem.attack;
            }
        }
        ...
        protected override void OnCollect(Collider other)
        {
            ...
            {
                Dialogue.Instance.ShowDialogueTextTemporarily("무기를 찾아라 퀘스트를 진행하세요. \n담당 NPC와 대화하면 퀘스트를 진행할 수 있습니다.");
        ...
        public void SetOwnerAttack(float attackAmount)
        {
            ownerAttackAmount = attackAmount;
        }
        ...
        private void FixedUpdate()
        {
            ...
            foreach(Collider collider in colliders)
            {
                ...
                if (damageable != null)
                {
                    damageable.ReceiveDamage(ownerAttackAmount + weaponAttackAmount);
                }
