...
namespace RPGGame
{
    public class WeaponController : MonoBehaviour
    {
        ...
        public void AttachWeapon(Weapon weapon)
        {
            ...
            PlayerStateManager playerStateManager = transform.root.GetComponentInChildren<PlayerStateManager>();
            if (playerStateManager != null)
            {
                weapon.SetOwnerAttack(playerStateManager.CurrentAttack);
            }
        ...
        {
            if (!IsWeaponAttached || weapon == null)
            {
                return;
            }

            weapon.SetOwnerAttack(attackAmount);
        }
